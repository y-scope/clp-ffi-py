...
PyObject* encode_preamble (PyObject* Py_UNUSED(self), PyObject* args) {
    ...
    const std::string timestamp_format(input_timestamp_format, input_timestamp_format_size);
    const std::string timezone(input_timezone, input_timezone_size);
    ...
    if (false ==
        ...
        PyErr_SetString(
                PyExc_NotImplementedError, clp_ffi_py::error_messages::Encoding::preamble_error);
        return nullptr;
    }
...
PyObject* encode_message_and_timestamp_delta (PyObject* Py_UNUSED(self), PyObject* args) {
    ...
    std::string logtype;
    std::vector<int8_t> ir_buf;
    std::string_view msg(input_buffer, input_buffer_size);
    ...
    if (false == ffi::ir_stream::four_byte_encoding::encode_message(msg, logtype, ir_buf)) {
        PyErr_SetString(
                PyExc_NotImplementedError, clp_ffi_py::error_messages::Encoding::message_error);
        return nullptr;
    }
    ...
    if (false == ffi::ir_stream::four_byte_encoding::encode_timestamp(delta, ir_buf)) {
        PyErr_SetString(
                PyExc_NotImplementedError, clp_ffi_py::error_messages::Encoding::timestamp_error);
        return nullptr;
    }
...
PyObject* encode_message (PyObject* Py_UNUSED(self), PyObject* args) {
    char const* input_buffer;
    Py_ssize_t input_buffer_size;
...
PyObject* encode_timestamp_delta (PyObject* Py_UNUSED(self), PyObject* args) {
    ffi::epoch_time_ms_t delta;
