#ifndef CLP_FFI_PY_IR_NATIVE_PY_ENCODING_METHODS
#define CLP_FFI_PY_IR_NATIVE_PY_ENCODING_METHODS

#include <clp_ffi_py/Python.hpp>  // Must always be included before any other header files

// Documentation for these methods is in clp_ffi_py/ir/native/PyFourByteEncoder.cpp, as it also
...
#endif  // CLP_FFI_PY_IR_NATIVE_PY_ENCODING_METHODS
