...
PyDoc_STRVAR(
        ...
        " See the supported encodings in the `Python Standard Encodings documentation"
        " <https://docs.python.org/3/library/codecs.html#standard-encodings>`_\n"
        ":type encoding: str\n"
        ":param errors: Specifies how decoding errors are handled. Refer to the `Python Error"
        " Handlers documentation <https://docs.python.org/3/library/codecs.html#error-handlers>`_"
