...
private:
    ...
    public:
        ...
        using SchemaTreeNodeInsertionHandle = std::function<
                clp::ffi::ir_stream::
                        IRErrorCode(bool is_auto_generated, clp::ffi::SchemaTree::NodeLocator, std::shared_ptr<clp::ffi::SchemaTree const> const&)>;
