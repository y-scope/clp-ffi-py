 ...
 */
[[nodiscard]] auto py_utils_get_formatted_timestamp(clp::ir::epoch_time_ms_t timestamp, PyObject* timezone)
        -> PyObject*;
 ...
 * @return nullptr on failure with the relevant Python exception and error set.
 */
[[nodiscard]] auto py_utils_get_timezone_from_timezone_id(std::string const& timezone_id) -> PyObject*;
