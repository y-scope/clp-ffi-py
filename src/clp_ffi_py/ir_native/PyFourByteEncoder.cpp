...
#include <clp_ffi_py/ir_native/encoding_methods.hpp>
...
PyMethodDef PyFourByteEncoder_method_table[]{
        {"encode_preamble",
         clp_ffi_py::ir_native::encode_four_byte_preamble,
         METH_VARARGS | METH_STATIC,
         static_cast<char const*>(cEncodePreambleDoc)},

        {"encode_message_and_timestamp_delta",
         clp_ffi_py::ir_native::encode_four_byte_message_and_timestamp_delta,
         METH_VARARGS | METH_STATIC,
         static_cast<char const*>(cEncodeMessageAndTimestampDeltaDoc)},

        {"encode_message",
         clp_ffi_py::ir_native::encode_four_byte_message,
         METH_VARARGS | METH_STATIC,
         static_cast<char const*>(cEncodeMessageDoc)},

        {"encode_timestamp_delta",
         clp_ffi_py::ir_native::encode_four_byte_timestamp_delta,
         METH_VARARGS | METH_STATIC,
         static_cast<char const*>(cEncodeTimestampDeltaDoc)},

        {"encode_end_of_ir",
         py_c_function_cast(clp_ffi_py::ir_native::encode_end_of_ir),
...
PyType_Spec PyFourByteEncoder_type_spec{
        "clp_ffi_py.ir.ir_native.FourByteEncoder",
